...
public class TeleOPTest extends LinearOpMode {
    ...
    public Toggle vertClawToggle = new Toggle(false);
    public Toggle horzClawToggle = new Toggle(false);
    ...
    public void runOpMode() throws InterruptedException {
        ...
        vertClawServo = hardwareMap.servo.get("vertClaw");
        horzClawServo = hardwareMap.servo.get("horzClaw");
        ...
        while (opModeIsActive()) {
            ...
            telemetry.addData("Claw Active", vertClawToggle.state);
            ...
            //update the toggles
            vertClawToggle.updateToggle(gamepad2.a);
            horzClawToggle.updateToggle(gamepad2.b);

            //update the servos
            vertClawServo.setPosition(leftClawPositions[vertClawToggle.state ? 1 : 0]);
            horzClawServo.setPosition(rightClawPositions[horzClawToggle.state ? 1 : 0]);
